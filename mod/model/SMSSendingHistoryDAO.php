 ...
 * --------------------------------------------------------------------
 * ZnetDK 4 Mobile SMS sending module DAO
 *
 * File version: 1.0
 * Last update: 05/15/2025 
 */
namespace z4m_smssending\mod\model;

class SMSSendingHistoryDAO extends \DAO {

    protected function initDaoProperties() {
        $this->table = "z4m_sms_sending_history";
        $this->dateColumns = array('sending_datetime');
    }
    ...
    protected function setStartAsFilter($startDate) {
        ...
        $this->filterClause .= 'sending_datetime >= ?';
